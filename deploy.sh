docker build -t paulyip34/multi-client:latest -t paulyip34/multi-client:$SHA -f ./client/Dockerfile ./client
...
kubectl set image deployments/client-deployment client=paulyip34/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=paulyip34/multi-worker:$SHA
